...
public class CritMultiplier {
    ...
    private static final double DEFAULT_VALUE = attributesConfig.getDefaultAttributeValue("crit_multiplier");
    private static final double MAX_VALUE = attributesConfig.getMaxAttributeValue("crit_multiplier");
    ...
    public static final Supplier<Attribute> CRIT_MULTIPLIER =
            ATTRIBUTES.register("crit_multiplier",
                    ()->new RangedAttribute("spiruraattribute.crit_multiplier", DEFAULT_VALUE, DEFAULT_VALUE, MAX_VALUE).setSyncable(true));
