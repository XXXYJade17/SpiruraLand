...
public class CritChance {
    ...
    private static final double DEFAULT_VALUE = attributesConfig.getDefaultAttributeValue("crit_chance");
    private static final double MAX_VALUE = attributesConfig.getMaxAttributeValue("crit_chance");
    ...
    public static final Supplier<Attribute> CRIT_CHANCE =
            ATTRIBUTES.register("crit_chance",
                    () -> new RangedAttribute("spiruraattribute.crit_chance", DEFAULT_VALUE, DEFAULT_VALUE, MAX_VALUE).setSyncable(true));
