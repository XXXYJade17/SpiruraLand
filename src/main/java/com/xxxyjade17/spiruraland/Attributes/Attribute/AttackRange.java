...
public class AttackRange {
    ...
    private static final double DEFAULT_VALUE = attributesConfig.getDefaultAttributeValue("attack_range");
    private static final double MAX_VALUE = attributesConfig.getMaxAttributeValue("attack_range");
    ...
    public static final Supplier<Attribute> ATTACK_RANGE =
            ATTRIBUTES.register("attack_range",
                    ()->new RangedAttribute("spiruraattribute.attack_range", DEFAULT_VALUE, DEFAULT_VALUE, MAX_VALUE).setSyncable(true));
