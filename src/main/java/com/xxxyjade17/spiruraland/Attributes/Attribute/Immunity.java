...
public class Immunity {
    ...
    private static final double DEFAULT_VALUE = attributesConfig.getDefaultAttributeValue("immunity");
    private static final double MAX_VALUE = attributesConfig.getMaxAttributeValue("immunity");
    ...
    public static final Supplier<Attribute> IMMUNITY =
            ATTRIBUTES.register("immunity",
                    ()->new RangedAttribute("spiruraattribute.immunity", DEFAULT_VALUE, DEFAULT_VALUE, MAX_VALUE).setSyncable(true));
