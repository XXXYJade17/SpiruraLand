...
//                // 设置无敌和隐形可以防止交互和视觉显示
//                firstMonster.deathTime = 0;
//                firstMonster.setHealth(1f);
...
//                firstMonster.setIsReviving(true);
//
...
////                        Objects.requireNonNull(firstMonster.level().getServer()).tell(new TickTask(
////                        Objects.requireNonNull(serverLevel.getServer()).getTickCount() + (30 * 20), // 30秒后
...
//        }
    ...
    private static void reviveMonster(FirstMonster monster, BlockPos respawnPos, ServerLevel serverLevel /*, double originalX, double originalY, double originalZ*/) {
        System.out.println("[RespawningMonster] Current tick: " + serverLevel.getServer().getTickCount());
